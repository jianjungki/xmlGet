...
return array(
	...
	// 应用图标 [必填]
	'ICON_URL'					=> SITE_URL . '/apps/forum/Appinfo/app_ico_16.png',
	// 应用图标 [必填]
	'LARGE_ICON_URL'			=> SITE_URL . '/apps/forum/Appinfo/app_ico_64.png',
	// 版本号 [必填]
	'VERSION_NUMBER'			=> '33566',
	// 后台入口 [选填]
	'ADMIN_ENTRY'				=> 'Admin/forumAllSetting',
	...
	'AUTHOR_NAME'				=> 'liguo',
	// 作者Email [必填]
	'AUTHOR_EMAIL'				=> 'liguo@zhishisoft.com',
	// 作者主页 [选填]
	'AUTHOR_HOMEPAGE_URL'		=> '',
	// 贡献者姓名 [选填]
	'CONTRIBUTOR_NAMES'			=> '申川',
);
?>
