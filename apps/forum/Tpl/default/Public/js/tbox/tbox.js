(function($) {
			...
			<table id="tbx_table" class="tb_popup" align="center" border="0" border="0" cellpadding="0" cellspacing="0"><tr><td> \
			  <div class="tb_body"> \
				<div class="tb_header" style="display:none;"> \
				  ...
				  <div class="tb_title">'+Lang.tbox_title+'</div> \
				</div> \
  ...
  $.tbox.alert  = function(info,title,type,button){
	  ...
	  var alert_image_url;
				switch(type){
					case 1:
						alert_image_url = JS_DIR+"/tbox/images/right_icon.gif";
						break;
					case 2:
						alert_image_url = JS_DIR+"/tbox/images/clew_icon.gif";
						break;
					case 3:
						alert_image_url = JS_DIR+"/tbox/images/clew_icon.gif";
  ...
  $.tbox.setButton = function (type,functionName,input_type){
	  ...
	  switch(type){
		  case 1:
			  button = '<p><input class="mr10" id="tb_button_yes" name="" type="button" value="'+Lang.tbox_submit+'" /></p>'
			  break;
		  case 2:
			  button = '<p><input class="mr10" id="tb_button_no" name="" type="button" value="'+Lang.tbox_submit+'" /></p>'
			  break;
		  case 3:
			  button = '<p><input id="tb_button_ok"  name="" type="button" value="'+Lang.tbox_submit+'" /><input class="ml5" name="" id="tb_button_no" type="button" value="'+Lang.tbox_cancel+'"/></p>'
			  break;
	  }
  ...
  $.tbox.input = function (info,title,type,button){
	  ...
	  switch(type){
	  	case "textarea":
	  		...
	  		break;
	  	case "text":
	  		html = '<input id="tb_input_text" class="txt" value="">';
	  		break;
	  }
		input = '<div class="tb_input" style="margin:0 20px">\
				<div class="tb_input_info lh22"> '+info+'</div>\
