...
VALUES
    ('group_share_weibo', '分享圈子', '','我在@{author} 的圈子 【{name}】 里玩得很嗨， {url} 推荐大家也来看看哦~', 'zh', 'group', 'weibo', 0, 1307590430),
...
VALUES  
	('', 'add_group', '创建圈子', 'group', '{action}{sign}了{score}{typecn}', '5', '5'),
	('', 'delete_group', '解散群租', 'group', '{action}{sign}了{score}{typecn}', '-5', '-5'),
	('', 'join_group', '加入圈子', 'group', '{action}{sign}了{score}{typecn}', '2', '2'),
	('', 'quit_group', '退出圈子', 'group', '{action}{sign}了{score}{typecn}', '-2', '-2'),
...
REPLACE INTO `ts_system_data` (`uid`,`list`,`key`,`value`,`mtime`) 
VALUES 
    (0,'group','version_number','s:5:"36263";','2012-07-12 00:00:00');